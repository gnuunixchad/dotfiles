...
hi('StatusLine',   { fg = 'White', bg = '#6f3f89', reverse = false, bold = false,       cterm = { reverse = false, bold = true }})
hi('StatusLineNC', { fg = 'White', bg = '#045575', reverse = false,                    cterm = { reverse = false } })
hi('TabLineFill',  { cterm = { reverse = true } })
hi('TabLineSel',   { bold = false, bg = '#6f3f89',       cterm = { bold = true } })
...
hi('@lsp.type.variable',      { link = 'Identifier' })
  ...
  hi('ColorColumn',  { bg = '#6f3f89',                            ctermbg = 'DarkRed' })
  ...
  hi('PmenuSel',     { bg = '#6f3f89',                           ctermfg = 'DarkGrey', ctermbg = 'Black' })
