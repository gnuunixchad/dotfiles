...
prompt() {
    if [ ! $UID -eq 0 ]; then
        if [ -n "$SSH_CONNECTION" ]; then
            PS1='\[\033[00;42m\]\u@\h\[\033[00;00m\] \[\033[01;40m\]\W$(__git_ps1 " %s")\[\033[00;00m\] \$ '
        else
            [ -n "$HISTFILE" ] && PS1='\[\033[00;44m\]\u@\h\[\033[00;00m\] \[\033[01;40m\]\W$(__git_ps1 " %s")\[\033[00;00m\] \$ '
            [ -z "$HISTFILE" ] && PS1='\[\033[00;100m\]\u@\h\[\033[00;00m\] \[\033[01;40m\]\W$(__git_ps1 " %s")\[\033[00;00m\] \$ '
        fi
    else
            PS1='\[\033[30;107m\]\u@\h\[\033[00;107m\] \[\033[01;40m\]\W$(__git_ps1 " %s")\[\033[00;00m\] \$ '
    fi
}
prompt
